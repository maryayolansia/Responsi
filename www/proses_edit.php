...
$update         = mysqli_query($conn, "UPDATE data_siswa SET nama_siswa ='$id_siswa', '$nama_siswa', alamat_siswa = '$alamat_siswa', notelp_siswa = '$notelp_siswa' WHERE id_siswa = '$id_siswa'");
